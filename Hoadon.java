...
// xóa hóa đơn
    ...
    new HoaDonModify().DeleteHD(sp.getMahd()); //gửi code lên đi ok
    showTableHD();
    ...
    private void table_hdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_hdMouseClicked
     ...
     sanphamct=new Chitet_hdModify().getchi_tiet_hdByMa_hd(ma_hd);
        ...
        sanphamct.forEach((chi_tiet_hd)->{
            ModelSPCT.addRow(new Object[]{table_chi_tiet_hd.getRowCount()+1,chi_tiet_hd.getMasp(),chi_tiet_hd.getSo_luong(),chi_tiet_hd.getGia_ban(),chi_tiet_hd.getTong()});
        });       
